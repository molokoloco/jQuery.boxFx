...
var http = require("http"),
    ...
    Converter = require("./js/Markdown.Converter").Converter,
    getSanitizingConverter = require("./js/Markdown.Sanitizer").getSanitizingConverter,
    conv = new Converter(),
...
}).listen(process.env.C9_PORT); // (8000);